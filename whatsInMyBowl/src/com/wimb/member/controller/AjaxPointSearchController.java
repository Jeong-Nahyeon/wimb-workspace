...
/**
 * Servlet implementation class AjaxPointSearchController
 */
@WebServlet("/pointCheck.me")
public class AjaxPointSearchController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxPointSearchController() {
        super();
