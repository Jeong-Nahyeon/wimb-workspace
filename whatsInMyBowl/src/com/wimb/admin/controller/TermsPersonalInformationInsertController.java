 ...
 */
@WebServlet("/insertPersonalInformation.terms")
public class TermsPersonalInformationInsertController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TermsPersonalInformationInsertController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new termsService().insertPersonalInformationTerms(termsContent);
