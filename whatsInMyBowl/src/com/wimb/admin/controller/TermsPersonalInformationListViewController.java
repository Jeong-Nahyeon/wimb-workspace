 ...
 */
@WebServlet("/listPersonalInformation.terms")
public class TermsPersonalInformationListViewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TermsPersonalInformationListViewController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/admin/termsPersonalInformationListView.jsp").forward(request, response);
