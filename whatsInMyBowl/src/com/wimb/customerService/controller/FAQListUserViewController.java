...
/**
 * Servlet implementation class FAQListUserViewController
 */
@WebServlet("/listUserView.faq")
public class FAQListUserViewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FAQListUserViewController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/customerService/FAQListAllView.jsp").forward(request, response);
	}
