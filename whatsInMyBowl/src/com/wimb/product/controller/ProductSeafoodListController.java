...
/**
 * Servlet implementation class ProductSeafoodListController
 */
@WebServlet("/seafoodList.pr")
public class ProductSeafoodListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductSeafoodListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("selectOrder") != null) { // 육류 옵션별 정렬 조회
			...
			request.getRequestDispatcher("views/product/productSeafoodListView.jsp").forward(request, response);
