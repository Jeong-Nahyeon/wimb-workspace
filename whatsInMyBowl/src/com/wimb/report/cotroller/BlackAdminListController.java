...
/**
 * Servlet implementation class BlackAdminListController
 */
@WebServlet("/list.black")
public class BlackAdminListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BlackAdminListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new ReportService().selectAdminBlackListCount();
