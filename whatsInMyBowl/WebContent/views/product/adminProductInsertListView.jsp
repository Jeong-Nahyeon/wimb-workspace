    ...
    <div class="outer">
        ...
        <div id="list" align="center">
            ...
            <div id="list-2">
                ...
                <!-- 상품등록 버튼 -->
                <div align="right">
                    <button type="button" id="insert-product" class="btn btn-sm btn-warning" style="background:rgb(255, 225, 90);" data-toggle="modal" data-target="#insert-modal" data-backdrop="static" data-keyboard="false">상품등록</button>
                </div>
            </div>
        ...
        <div class="modal fade" id="insert-modal">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content insert-product-modal">
