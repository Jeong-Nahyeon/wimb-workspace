...
<body>
    ...
    <div class="outer">
		...
		<form id="enroll-form" action="<%= contextPath %>/update.no" method="post" enctype="multipart/form-data">
	        ...
	        <input type="hidden" name="nno" value="<%= n.getNoticeCode()%>">
	        <table>
	            <tr>
	                <td class="insertNotice_title">제목</td>
	                <td><input type="text" name="title" id="title" class="insertNotice_title_input" value="<%= n.getNoticeTitle() %>" required></td>
	            </tr>
	            <tr>
	            ...
	            <tr>
	                ...
	                <td><textarea name="content" cols="100" rows="20"  class="insertNotice_content_textarea" required style="resize: none;"><%= n.getNoticeContent() %></textarea></td>
	            </tr>
	        </table>
