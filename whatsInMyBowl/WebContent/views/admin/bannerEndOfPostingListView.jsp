...
<body>
    ...
    <div class="bannerList">
        ...
        <div class="paging-area">
            ...
            <% if(currentPage != 1) { %>
            	<button onclick="location.href='<%= contextPath %>/EndOfPostinglist.banner?cpage=<%=currentPage-1%>';">&lt;</button>
            <% } %>
            ...
            <% for(int p=startPage; p<=endPage; p++) { %>
            	...
            	<% } else { %>
            		<button onclick="location.href='<%= contextPath %>/EndOfPostinglist.banner?cpage=<%= p %>';"><%= p %></button>
            	<% } %>
            <% } %>
